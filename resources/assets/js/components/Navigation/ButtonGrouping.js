       ...
       <Modal 
        ...
        >
          ...
          <Modal.Body style={{
            ...
            paddingBottom:'0px'}}>
          <img src='/img/logo/donateABLE-long-white-500.png' style={{width: '70%'}}/>
          <ModalText style={{marginBottom: '10%'}} fontSize1={20} fontSize2={14} text1='THANK YOU FOR VISITING' text2='WE WOULD LIKE TO HEAR FROM YOU' />
          ...
          <hr width={'69%'} noshade  style={{display: 'block', height: '1px',
            ...
            {/* JOIN THE PROGRAM */}
            <img src='/img/contactus/Contact-Us-Join-the-Program.png' style={{width: '80%'}}/>
          ...
          {/* Technical Support */}
          <img src='/img/contactus/Contact-Us-Technical-Support.png' style={{width: '80%'}}/>
          <p style={{color: '#FFFFFF'}}>
