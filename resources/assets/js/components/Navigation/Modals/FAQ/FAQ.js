...
let titleText3 = "What crypto currency is being mined?                    ";
    ...
    render() {
        return (
          ...
          `}
                ...
                <FAQItem title={titleText1} bodyText={paragraph1} />
                <FAQItem title={titleText2} bodyText={paragraph2} />
                <FAQItem title={titleText3} bodyText={paragraph3} />
                <FAQItem title={titleText4} bodyText={paragraph4} />
                <FAQItem title={titleText5} bodyText={paragraph5} />
                <FAQItem title={titleText6} bodyText={paragraph6} />
            </div>
        );
    }
}
