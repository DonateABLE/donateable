    ...
    <div>
      <Container style={{backgroundColor: '#FFFFFF', color:'black', fontWeight: 200, marginBottom: '3%'}}>
        ...
        <br />
          ...
          This privacy notice discloses the privacy practices for donateABLE and our website; 
          https://www.donateable.ca. This privacy notice applies solely to information collected 
        ...
        <br/>
        <br/>
        Unless you ask us not to, we may contact you via email in the future to tell you about statistics,
          new charities or features, or changes to this privacy policy.
        <br/>
        <br/>
        ...
        by contacting us via the contact form provided on our website:
        <br/>
        <br/>
        <ul>
        ...
        information offline. Only employees who need the information to perform a specific job (e.g. billing 
        or customer service) are granted access to personally identifiable information. The computers/servers 
        on which we store personally identifiable information are kept in a secure environment.
        <br/>
        <br/>
        ...
        enhance their experience on our site. Usage of a cookie is in no way linked to any personally identifiable 
        information on our site.
        Some of our business partners may use cookies on our site (e.g., advertisers). However, we have no 
        ...
        <strong>If you feel that we are not abiding by this privacy policy, you should contact us immediately 
          via email at support@donateable.ca.</strong>
      </Container>
    </div>
  )
}
