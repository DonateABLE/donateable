      ...
      <div class="modal-body" id="FormContainer">
          ...
          <div class="step-container">
              <div class="step form" style="width:100%;">
                  <img class="contact-img" src="{{asset('img/contactus/Contact-Us-Join-the-Program.png')}}"/>
              ...
              <div class="step" style="width:7.5px;background-color:white; padding: 0px;"></div>
              <div class="step form" style="width:100%;">
                  <img class="contact-img" src="{{asset('img/contactus/Contact-Us-Technical-Support.png')}}"/>
